<div class=" max-w-md mx-auto">
    <!-- Hero Section -->
    <div class=" rounded-xl h-screen overflow-hidden">

        <div
            class="w-full overflow-hidden  bg-white/5 backdrop-blur-xl border border-white/10 shadow-2xl">

            {{-- Image --}}
            <div class="relative">
                <img src="{{ asset('storage/' . ($hero->image ?? 'default.jpg')) }}" alt="Profile"
                    class="w-full h-[520px] object-cover object-top">
                ...
                <div class="absolute bottom-0 p-6 text-white">
                    ...
                    <p class="text-sm text-zinc-300 mt-2 max-w-xs">
                        {{ $hero->subtitle ?? 'I craft precise digital experiences with clarity & emotional impact.' }}
                    </p>

                    {{-- Stats --}}
                    <div class="flex justify-between mt-6 text-sm text-zinc-300 border-t border-white/10 pt-4">
                        <div>
                            <p class="text-white font-semibold">4.9</p>
                            <p class="text-xs">Rating</p>
                        </div>
                        <div>
                            <p class="text-white font-semibold">$120k+</p>
                            <p class="text-xs">Earned</p>
                        </div>
                        <div>
                            <p class="text-white font-semibold">$75/hr</p>
                    ...
                    <div class="mt-6 flex gap-3">
                        <a href="{{ $hero->cta_link ?? '#' }}"
                            class="flex-1 text-center py-3 rounded-xl bg-red-900 hover:bg-red-800 transition-all duration-300 font-medium shadow-lg hover:shadow-red-900/40">
                            {{ $hero->cta_text ?? 'Get In Touch' }}
                        </a>

                        <button
                            class="w-12 h-12 rounded-xl bg-white/10 border border-white/10 flex items-center justify-center hover:bg-white/20 transition">
                            ☆
                        </button>
                    </div>
