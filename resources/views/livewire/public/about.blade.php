<div class="min-h-screen bg-[#0b0b0d] text-white antialiased selection:bg-orange-500 selection:text-white">
    ...
    <div class="fixed top-8 left-6 md:left-12 z-[100]">
        <a href="{{ route('home') }}"
            ...
            <span class="text-[10px] font-black uppercase tracking-[0.2em] text-white/70 group-hover:text-white transition-colors">Return Home</span>
        </a>
    </div>

    {{-- 2. Massive Background Text --}}
    <div class="absolute top-20 left-1/2 -translate-x-1/2 text-[30vw] font-black text-white/[0.01] select-none pointer-events-none leading-none z-0">
        WHO
    </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-24 items-start">
            ...
            <div class="lg:col-span-5 sticky top-32">
                <div class="relative group">
                    ...
                    <div class="absolute -inset-10 bg-orange-600/20 rounded-full blur-[100px] opacity-50 group-hover:opacity-100 transition-opacity duration-1000"></div>
                    
                    {{-- Image Frame --}}
                    <div class="relative aspect-[3/4] rounded-[60px] overflow-hidden border border-white/10 bg-zinc-900 shadow-2xl">
                        @if ($about->image)
                    ...
                    <div class="absolute -bottom-6 -right-6 bg-orange-600 p-8 rounded-[40px] shadow-2xl shadow-orange-900/40 hidden md:block">
                ...
                <div class="mt-16 flex items-center gap-8 justify-center lg:justify-start">
                    @foreach(['LinkedIn', 'Twitter', 'GitHub'] as $social)
                        <a href="#" class="text-[10px] font-black uppercase tracking-[0.3em] text-white/30 hover:text-orange-500 transition-colors">{{ $social }}</a>
                    @endforeach
                </div>
            </div>
            ...
            <div class="lg:col-span-7">
                ...
                <div class="mb-16">
                    ...
                    <h1 class="text-6xl md:text-8xl lg:text-9xl font-black tracking-tighter leading-[0.85] text-white mb-10">
                        {{ $about->title ?? 'About' }}<span class="text-orange-500">.</span>
                    </h1>

                    <p class="text-2xl md:text-3xl text-white/80 font-medium leading-relaxed italic border-l-4 border-orange-500 pl-8 mb-12">
                ...
                <div class="prose prose-invert prose-lg max-w-none text-white/50 leading-relaxed
                ...
                <div class="mt-20 pt-12 border-t border-white/5 grid grid-cols-2 md:grid-cols-3 gap-12">
                    @foreach(['Strategy', 'Design', 'Development'] as $label)
                        <div>
                            <h4 class="text-orange-500 font-black text-[10px] uppercase tracking-[0.3em] mb-4">{{ $label }}</h4>
    ...
    <footer class="py-32 bg-white text-black rounded-t-[60px] md:rounded-t-[100px] overflow-hidden relative">
        ...
        <div class="relative z-10 max-w-3xl mx-auto px-6 text-center">
            ...
            <div class="flex flex-col sm:flex-row items-center justify-center gap-8">
                ...
                <a href="{{ route('home') }}#works" class="text-sm font-black uppercase tracking-[0.2em] border-b-2 border-black/10 hover:border-black transition-all pb-1">
                    See my works
                </a>
            </div>
        </div>
