        ...
        <div class="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
            <div class="grid grid-cols-1 md:grid-cols-12 gap-16 md:gap-8 mb-24">
                ...
                <div class="md:col-span-3">
                    ...
                    <ul class="space-y-4">
                        <li><a href="#works"
                                class="text-white/60 hover:text-orange-500 font-bold transition-colors">Portfolio</a>
                        </li>
                        <li><a href="#services"
                                class="text-white/60 hover:text-orange-500 font-bold transition-colors">Expertise</a>
                        </li>
                        <li><a href="#about" class="text-white/60 hover:text-orange-500 font-bold transition-colors">My
                                Story</a></li>
                    </ul>
                </div>
